...
Vagrant.configure("2") do |config|
  ...
  config.vm.hostname = "alexandt-starter"
  ...
  #   chef.chef_server_url = "https://api.opscode.com/organizations/tynet"
  #   chef.validation_client_name = "tynet-validator"
  #   chef.validation_key_path = ".chef/tynet-validator.pem"
  # end
end
